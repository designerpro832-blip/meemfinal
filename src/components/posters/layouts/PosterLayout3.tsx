...
const PosterLayout3: React.FC<PosterLayoutProps> = ({ program, winners, styles, designWidth, isForDownload }) => {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-brand-dark-blue via-brand-mid-blue to-brand-dark-teal text-ui-text-light font-sans relative overflow-hidden">
      ...
      {winner1 && (
        <>
          <StyledText style={styles.winner1Name} designWidth={designWidth} isForDownload={isForDownload} className="leading-tight">{winner1.participant}</StyledText>
      ...
      {winner2 && (
        <>
          <StyledText style={styles.winner2Name} designWidth={designWidth} isForDownload={isForDownload} className="leading-tight">{winner2.participant}</StyledText>
      ...
      {winner3 && (
        <>
          <StyledText style={styles.winner3Name} designWidth={designWidth} isForDownload={isForDownload} className="leading-tight">{winner3.participant}</StyledText>
